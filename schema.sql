...
-- Ralawise catalogue sectors and collections. These are intentionally kept
-- separate from product types and from the legacy related_sectors taxonomy.
CREATE TABLE IF NOT EXISTS "catalog_groups" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "group_type" character varying(20) NOT NULL CHECK (group_type IN ('sector', 'collection')),
  "name" character varying(200) NOT NULL,
  "slug" character varying(200) NOT NULL,
  "display_order" integer DEFAULT 0,
  "created_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "product_catalog_groups" (
  ...
  "source" character varying(50) NOT NULL DEFAULT 'ralawise-categorisation',
  "created_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
